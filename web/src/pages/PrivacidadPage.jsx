  ...
  return (
    <section style={{ background: '#fff', padding: '8rem 0', minHeight: '100vh' }}>
      <div className="container" style={{ maxWidth: 860 }}>
        <h1 className="fw-bold mb-4" style={{ fontSize: '2rem', color: '#1a1a1a' }}>Políticas de Privacidad</h1>
        ...
        {/* Sección 1 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>1. Aceptación de los Términos y Condiciones</h3>
        ...
        {/* Sección 2 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>2. Naturaleza del Servicio y Limitación de Responsabilidad</h3>
        ...
        {/* Sección 3 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>3. Derechos de Acceso, Rectificación y Supresión (Habeas Data)</h3>

        <h5 className="fw-bold mt-3" style={{ color: '#1a1a1a' }}>3.1.</h5>
        <p style={{ color: '#555', lineHeight: 1.8 }}>
        ...
        {/* Sección 4 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>4. Uso de la Plataforma</h3>
        ...
        {/* Sección 5 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>5. Propiedad Intelectual</h3>
        ...
        {/* Sección 6 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>6. Régimen de Adquisición de Informes y Devoluciones</h3>

        <h5 className="fw-bold mt-3" style={{ color: '#1a1a1a' }}>6.1.</h5>
        <p style={{ color: '#555', lineHeight: 1.8 }}>
        ...
        {/* Sección 7 */}
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>7. Ley Aplicable y Jurisdicción Competente</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>2. Datos Recolectados y Ausencia de Base de Datos Crediticia</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>3. Finalidad del Tratamiento</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>4. Transferencia de Datos a Terceros</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>5. Seguridad de la Información</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>6. Cookies</h3>
        ...
        <h3 className="fw-bold mt-4" style={{ fontSize: '1.2rem', color: '#1a1a1a' }}>7. Modificaciones a la Política</h3>
