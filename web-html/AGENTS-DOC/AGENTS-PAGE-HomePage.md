...
- `include/search-bar.php` (inside hero section)

## JavaScript needed
- HomePage slider: auto-scroll every 1s, 8 real slides + 8 cloned (16 total), CARD_WIDTH=228, responsive gap (24/16/12px), cubic-bezier transition, infinite loop reset (see `js/scripts.js`)

## Data (hardcoded)

### Slider items (8 items, rendered twice = 16 slides)
| # | title | icon |
|---|---|---|
| 1 | Datos Personales | bi-person-vcard |
| 2 | Scoring | bi-graph-up-arrow |
| 3 | Domicilios, Contactos, Gmails | bi-geo-alt |
| 4 | Vínculos y Familiares | bi-diagram-3 |
| 5 | Historial laboral e ingresos | bi-briefcase |
| 6 | Historial de vehículos | bi-truck |
| 7 | Situación financiera | bi-bank |
| 8 | Perfil Fiscal y Comercial | bi-clipboard-data |

### Plans (8 items for benefits section)
...
| 2 | Scoring | Índice numérico de solvencia del 1 al 999. Analiza el comportamiento de pago histórico y proyecta el nivel de riesgo crediticio. | bi-graph-up-arrow |
...
| 8 | Perfil Fiscal y Comercial | Detalle de inscripción como Monotributista o Autónomo. Participación en sociedades y registro de cheques rechazados. | bi-clipboard-data |
