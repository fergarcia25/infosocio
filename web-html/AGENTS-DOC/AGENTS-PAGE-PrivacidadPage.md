...
<section style="background: #fff; padding: 8rem 0; min-height: 100vh;">
  <div class="container" style="max-width: 860px;">
    ...
    <h1 class="fw-bold mb-4" style="font-size: 2rem; color: #1a1a1a;">Políticas de Privacidad</h1>

    <p style="color: #555; line-height: 1.8; margin-bottom: 2rem;">
      Aquí tenés los dos documentos (Términos y Condiciones y Políticas de Privacidad) completamente reformulados y adaptados a tu realidad de negocio.
    </p>

    <p style="color: #555; line-height: 1.8; margin-bottom: 3rem;">
      Al ser un intermediario o proveedor secundario, tu responsabilidad legal cambia drásticamente: vos no almacenás ni procesás la base de datos comerciales, sino que facilitás el acceso al servicio de un tercero. Dejar esto en claro en tus textos te protege de reclamos legales por errores en los datos o demoras en los trámites de rectificación (Habeas Data).
    </p>

    <hr class="mb-5" />

    <h2 class="fw-bold mb-4" style="font-size: 1.5rem; color: #b71c1c;">TÉRMINOS Y CONDICIONES DE USO - INFOSOCIO.COM</h2>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">1. Aceptación de los Términos y Condiciones</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">1.1.</h5>
    ...
    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">1.2.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">1.3.</h5>
    <p style="color: #555; line-height: 1.8;">
      El uso de esta web está destinado a personas humanas mayores de edad y personas jurídicas legalmente constituidas habilitadas para contratar en el país.
    </p>

    <hr class="my-5" />

    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">2. Naturaleza del Servicio y Limitación de Responsabilidad</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">2.1.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">2.2.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">2.3.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">3. Derechos de Acceso, Rectificación y Supresión (Habeas Data)</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">3.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      En cumplimiento de la Ley 25.326 de Protección de Datos Personales, el Usuario conserva todos sus derechos de acceso, rectificación, actualización y supresión de datos.
    </p>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">3.2.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">3.3.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">4. Uso de la Plataforma</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">4.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      El Usuario se compromete a utilizar la Plataforma de manera lícita, respetando la legislación argentina vigente, la moral y el orden público. Queda terminantemente prohibido el uso del sitio para fines ilegales, recolección automatizada de datos (scraping), ataques informáticos o suministro de información de contacto falsa.
    </p>

    <hr class="my-5" />

    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">5. Propiedad Intelectual</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">5.1.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">6. Régimen de Adquisición de Informes y Devoluciones</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">6.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      Debido a que el servicio consiste en la provisión de datos digitales de descarga e interpretación instantánea (PDF), el costo del informe no es pasible de devolución una vez entregado o descargado, ya que la contraprestación se extingue en el acto.
    </p>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">6.2.</h5>
    <p style="color: #555; line-height: 1.8;">
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">7. Ley Aplicable y Jurisdicción Competente</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">7.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      Los presentes Términos y Condiciones se rigen por las leyes de la República Argentina. Cualquier controversia derivada del uso del sitio o los servicios se someterá a los Tribunales Ordinarios de la Ciudad de Córdoba, Provincia de Córdoba.
    </p>

    <hr class="my-5" />

    <h2 class="fw-bold mb-4" style="font-size: 1.5rem; color: #b71c1c;">POLÍTICAS DE PRIVACIDAD - INFOSOCIO.COM</h2>

    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">1. Ámbito de Aplicación</h3>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">2. Datos Recolectados y Ausencia de Base de Datos Crediticia</h3>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">3. Finalidad del Tratamiento</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">3.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      Los datos de contacto provistos por el Usuario se utilizan exclusivamente para:
    </p>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">4. Transferencia de Datos a Terceros</h3>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">5. Seguridad de la Información</h3>
    ...
    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">6. Cookies</h3>

    <h5 class="fw-bold mt-3" style="color: #1a1a1a;">6.1.</h5>
    <p style="color: #555; line-height: 1.8;">
      El sitio utiliza cookies esenciales y herramientas de analítica web para optimizar la experiencia de navegación del usuario y medir el tráfico del sitio de forma anónima. El usuario puede configurar su navegador para bloquear las cookies, sabiendo que esto podría afectar algunas funciones de compra de la web.
    </p>

    <hr class="my-5" />

    <h3 class="fw-bold mt-4" style="font-size: 1.2rem; color: #1a1a1a;">7. Modificaciones a la Política</h3>
