...
## Notes
- Show the form state with a static persona example (not the "no persona" fallback state).
- Form is static markup only — no action, method, or JS validation.
- Price is static: $ 15.200
- Back button is a simple link.
